// FornecedorEncomendaProdutos.jsx
import React, { useState } from 'react';
import 'bootstrap/dist/css/bootstrap.css';
import './style.css';

const FornecedorEncomendaProdutos = ({ associados, produtosDisponiveis, setAssociados }) => {
          ...
          {associados.length > 0 ? (
            associados.map(p => (
              <tr key={p.ProdutoID}>
                ...
                <td>{Number(p.ValorIVA).toFixed(2)} €</td>
...
export default FornecedorEncomendaProdutos;
